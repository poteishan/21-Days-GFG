...
let close = document.querySelector("#profile .fa-close");
let profile_see = document.querySelector(".profile-btn");
let profile_section = document.querySelector("#profile");

profile_see.addEventListener("click", function () {
    profile_section.classList.toggle("collapse");
});

close.addEventListener("click", function () {
    profile_section.classList.add("collapse");
});
